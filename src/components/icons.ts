...
export const icons: Record<string, string> = {
  ...
  cp: '<path fill-rule="evenodd" d="M6 2h12a4 4 0 0 1 4 4v12a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V6a4 4 0 0 1 4-4zm.5 2h11A2.5 2.5 0 0 1 20 6.5v11a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 17.5v-11A2.5 2.5 0 0 1 6.5 4z"/><path d="M12 16.5 6.5 7.5h2.3L12 13l3.2-5.5h2.3zM12 7.6l2 2.4-2 2.4-2-2.4zM11.2 16h1.6v3.2h-1.6z"/>',
